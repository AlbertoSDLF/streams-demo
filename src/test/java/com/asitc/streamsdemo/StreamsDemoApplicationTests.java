...
import com.asitc.streamsdemo.entity.Employee;
import com.asitc.streamsdemo.entity.EmployeeRepository;
...
public class StreamsDemoApplicationTests {
	...
	public void whenCollectBySet_thenGetSet() {
		Set<String> empNames = empList.stream().map(Employee::getName).collect(Collectors.toSet());
